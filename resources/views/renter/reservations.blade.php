      ...
      @include('renter.sidebar')
        ...
        <div class="row">
            ...
            <div class="card-header bg-success text-white">
                    Create at: {{$re->created_at}}
                </div>
                <div class="card-body">
                    <h5 class="card-title">{{$re->room->name}}</h5>
                    <h6 class="card-subtitle mb-2 text-muted">ID Reservations: {{$re->id}}</h6>
                    <p class="card-text">Name of booker: {{$re->user->name}}</p>
                    ...
                    </svg>Check IN: {{$re->start_date}}</h6>
                </div>
                <div class="card-footer bg-light">
                    <a href="#" class="card-link btn btn-primary">View more about this reservation</a>
                    </div>
                </div>
                </div>
            @endforeach
        ...
        <div class="col-lg-3 mt-2">
            ...
            <div class="card-header bg-danger text-white">
                ...
                <div class="card-footer bg-light">
                    <a href="#" class="card-link btn btn-info">View more</a>
                    <a href="#" class="card-link btn btn-primary">Accept reservation</a>
                    </div>
                </div>
                </div>
            @endforeach
