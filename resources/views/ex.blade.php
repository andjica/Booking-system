...
<div class="container">
    <div class="row">
        ...
        <div class="panel-heading display-table border-dark mb-5">
            ...
            <form action="{{route('stpayex')}}" method="post" id="payment-form">
            @csrf
            <div class="form-row">
            ...
            <p><h1>Features:</h1>
                <ul>
                    <li>Buy a Business Exclusive Account</li>
                    <li>With this account you can so make many rooms / apartaments</li>
                    <li>Let's prepare for users best location and choose</li>
                    <li>Make a unlimited apartaments / rooms</li>
